                ...
                <form method="POST" action="{{ route('leaves.store') }}" id="leaveForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                               id="start_date" name="start_date" value="{{ old('start_date', $today) }}"
                               min="{{ $today }}" required>
                        @error('start_date')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                               id="end_date" name="end_date" value="{{ old('end_date', $today) }}"
                               min="{{ $today }}" required>
                        @error('end_date')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('reason') is-invalid @enderror"
                                  ...
                                  maxlength="500" placeholder="Enter the reason for your leave">{{ old('reason') }}</textarea>
